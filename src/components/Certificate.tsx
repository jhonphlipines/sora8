  ...
  return <div className="w-full max-w-5xl mx-auto px-4">
      ...
      aspectRatio: '1.414/1'
        ...
        <div className="absolute inset-0 p-2">
          ...
          <div className="absolute inset-6 border border-amber-400"></div>
        </div>
        ...
        {/* Content Container */}
        <div className="relative z-10 h-full flex flex-col items-center justify-between py-8 md:py-12 px-8 md:px-16">
          {/* Header with Logo */}
          <div className="text-center">
            ...
            <p className="text-lg md:text-xl text-amber-700 font-medium tracking-[0.3em] uppercase mt-1">
              of Completion
            </p>
            <div className="flex items-center justify-center gap-3 mt-4">
              <div className="h-px w-16 md:w-24 bg-gradient-to-r from-transparent to-amber-500"></div>
              <div className="w-2 h-2 bg-amber-500 rotate-45"></div>
              <div className="h-px w-16 md:w-24 bg-gradient-to-l from-transparent to-amber-500"></div>
            </div>
          </div>

          {/* Main Content */}
          <div className="text-center flex-1 flex flex-col justify-center py-4">
            <p className="text-gray-600 text-sm md:text-lg italic mb-2">This is to certify that</p>
            
            <h2 className="text-2xl md:text-4xl lg:text-5xl font-serif font-bold text-gray-900 border-b-2 border-amber-500 pb-2 px-4 inline-block mx-auto">
              {studentName}
            </h2>
            
            <p className="text-gray-600 text-sm md:text-lg italic mt-4 mb-2">has successfully completed the course</p>
            
            <h3 className="text-xl md:text-3xl font-semibold text-amber-700 max-w-2xl mx-auto leading-tight">
              {courseName}
            </h3>
          ...
          <div className="w-full">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              ...
              <div className="text-center">
                <div className="w-20 md:w-24 h-20 md:h-24 rounded-full border-2 border-amber-400 flex items-center justify-center bg-gradient-to-br from-amber-50 to-amber-100">
                  <Award className="w-10 h-10 md:w-12 md:h-12 text-amber-600" />
                </div>
              ...
              <div className="text-center md:text-right">
                ...
                <p className="text-xs md:text-sm font-mono text-gray-700">{certificateId.slice(0, 16)}</p>
              </div>
            </div>
            
            <div className="text-center mt-4">
              <p className="text-xs text-gray-400">Issued by CodeCert Labs • Verified Digital Certificate</p>
            </div>
          </div>
        </div>
      </div>
