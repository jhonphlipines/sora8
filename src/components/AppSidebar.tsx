...
const mainItems = [
  ...
  { title: "Analysis", url: "/data-analysis", icon: BarChart3 },
...
const labItems = [
  { 
    ...
    icon: BookOpen, 
    subItems: [
      { title: "courses", url: "/learn", icon: Code },
  ...
  { 
    ...
    icon: Trophy, 
    subItems: [
      { title: "Quick Tests", url: "/tests", icon: Target },
      { title: "Level Tests", url: "/levels", icon: BarChart3 },
      { title: "Certification", url: "/tests", icon: Award },
    ]
  },
];

const adminItems = [
  { title: "Lab Settings", url: "/settings", icon: Settings },
