...
const videoCourses: VideoCourse[] = [
  ...
  },
  {
    ...
    description: "Explores how data is stored in memory using arrays, the compilation process, string manipulation, and passing arguments into programs via the command line.",
  ...
  },
  {
    ...
    description: "A deep dive into computational efficiency, featuring search algorithms like linear and binary search, and sorting techniques such as bubble, selection, and merge sort.",
  ...
  },
  {
    ...
    description: "Demystifying memory management through pointers, hexadecimal notation, and addresses, while understanding how files like images are structured and stored.",
